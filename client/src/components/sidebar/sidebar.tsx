...
const Sidebar: React.FC<Props> = ({
  ...
  return (
    <div className="sidebar">
      ...
      {users.map((user)=>
        <div key={user.toString()} className="user-in-sidebar">
          <img src={userIcon} width="48" height="48" alt="Аватарка пользователя"/>
          <p className="user-in-story">{user}</p>
          {isChecked && <svg className="check" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
